...
[block.sum](https://docs.modular.com/api/mojo/max/gpu/primitives/block/sum) and
[block.broadcast](https://docs.modular.com/api/mojo/max/gpu/primitives/block/broadcast)
...
### 4. **[block.broadcast()](https://docs.modular.com/api/mojo/max/gpu/primitives/block/broadcast) API concepts**
