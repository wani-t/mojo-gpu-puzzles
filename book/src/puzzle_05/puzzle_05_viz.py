...
class Puzzle05Visualization(Scene):
    def construct(self):
        ...
        input_label_a = Text("Input Vector A (size=2)", font_size=18).next_to(
        ...
        input_label_b = Text("Input Vector B (size=2)", font_size=18).next_to(
        ...
        self.play(
            Create(input_bg_a),
            Create(input_vector_a),
            Create(input_bg_b),
            Create(input_vector_b),
            run_time=1.5,
        )
